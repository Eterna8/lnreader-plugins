...
window.fetch = function () {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var resource, config, _res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    resource = args[0], config = args[1];
                    if (!resource.toString().includes('localhost')) return [3 /*break*/, 2];
                    return [4 /*yield*/, originalFetch(resource, config)];
                case 1: return [2 /*return*/, _a.sent()];
                case 2: return [4 /*yield*/, originalFetch('http://localhost:3000/' + resource, __assign(__assign({}, config), { credentials: 'include', mode: 'cors' }))];
                case 3:
                    _res = _a.sent();
